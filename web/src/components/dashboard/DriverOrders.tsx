...
export default function DriverOrders({ localidad }: { localidad: string }) {
  ...
  const entregar = async (pedido: DriverOrder) => {
    const metodo = metodos[pedido.id] || "Efectivo";
    try {
